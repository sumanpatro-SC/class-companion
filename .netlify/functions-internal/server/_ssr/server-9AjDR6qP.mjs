...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CQgBuHU6.mjs");
...
const manifest = {
  "4a047136e1661a55d862782880f1d9d7e75e17a0bd7db5d1f054dd839da434cc": {
    functionName: "fetchSheetCsv_createServerFn_handler",
    importer: () => import("./sheet.functions-Daxl7uvV.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B_4R9uG5.mjs"),
    import("./start-D1vV4Dhw.mjs"),
